...
def create_app(test_config=None):
    ...
    app.config.update(
        ...
        AUDIOLETTER_BUCKET_NAME=os.environ.get("AUDIOLETTER_BUCKET_NAME", ""),
        AUDIOLETTER_BUCKET_ENDPOINT=os.environ.get("AUDIOLETTER_BUCKET_ENDPOINT", ""),
        AUDIOLETTER_BUCKET_REGION=os.environ.get("AUDIOLETTER_BUCKET_REGION", "auto"),
        AUDIOLETTER_BUCKET_ACCESS_KEY_ID=os.environ.get("AUDIOLETTER_BUCKET_ACCESS_KEY_ID", ""),
        AUDIOLETTER_BUCKET_SECRET_ACCESS_KEY=os.environ.get("AUDIOLETTER_BUCKET_SECRET_ACCESS_KEY", ""),
        AUDIOLETTER_BUCKET_ADDRESSING_STYLE=os.environ.get("AUDIOLETTER_BUCKET_ADDRESSING_STYLE", "auto"),
